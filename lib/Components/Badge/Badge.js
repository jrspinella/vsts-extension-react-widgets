define(["require", "exports", "tslib", "react", "../Utilities/BaseFluxComponent", "OfficeFabric/Callout", "OfficeFabric/Label", "OfficeFabric/Utilities", "VSSUI/VssIcon", "./Badge.scss"], function (require, exports, tslib_1, React, BaseFluxComponent_1, Callout_1, Label_1, Utilities_1, VssIcon_1) {
    "use strict";
            ...
            return React.createElement("div", { className: Utilities_1.css("badge", this.props.className) },
                React.createElement("div", { className: "badge-container", onMouseEnter: this._onMouseOver, onMouseLeave: this._onMouseOut, onClick: this._onClickCallout },
                    React.createElement("div", { ref: function (element) { return _this._calloutTargetElement = element; } },
                        React.createElement(VssIcon_1.VssIcon, { iconType: VssIcon_1.VssIconType.fabric, iconName: "Ringer", className: "badge-icon" })),
                    React.createElement(Label_1.Label, { className: "badge-notification-count" }, this.props.notificationCount)),
                this.state.isCalloutVisible &&
                    React.createElement(Callout_1.Callout, { gapSpace: 0, target: this._calloutTargetElement, onDismiss: this._dismissCallout, setInitialFocus: true, isBeakVisible: true, directionalHint: this.props.directionalHint || 6 },
