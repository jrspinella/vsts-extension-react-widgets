define(["require", "exports", "tslib", "react", "../../Flux/Actions/WorkItemTypeActions", "../../Flux/Stores/BaseStore", "../../Flux/Stores/WorkItemTypeStore", "../Utilities/BaseComponent", "OfficeFabric/Link", "./TitleView.scss"], function (require, exports, tslib_1, React, WorkItemTypeActions_1, BaseStore_1, WorkItemTypeStore_1, BaseComponent_1, Link_1) {
    "use strict";
    ...
    var TitleView = (function (_super) {
        ...
        TitleView.prototype.render = function () {
            ...
            return (React.createElement("div", { className: this.getClassName() + " " + ((witIconUrl || !wit) ? "no-color" : ""), style: (witIconUrl || !wit) ? undefined : { borderColor: witColor } },
