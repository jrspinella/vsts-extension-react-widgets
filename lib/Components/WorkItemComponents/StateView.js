define(["require", "exports", "tslib", "react", "../../Flux/Actions/WorkItemStateItemActions", "../../Flux/Stores/BaseStore", "../../Flux/Stores/WorkItemStateItemStore", "../../Utilities/Array", "../../Utilities/String", "../Utilities/BaseFluxComponent", "OfficeFabric/Label", "OfficeFabric/Utilities", "./StateView.scss"], function (require, exports, tslib_1, React, WorkItemStateItemActions_1, BaseStore_1, WorkItemStateItemStore_1, Array_1, String_1, BaseFluxComponent_1, Label_1, Utilities_1) {
    ...
    var StateView = (function (_super) {
        ...
        StateView.prototype.componentWillReceiveProps = function (nextProps) {
            _super.prototype.componentWillReceiveProps.call(this, nextProps);
            if (!String_1.StringUtils.equals(nextProps.state, this.props.state, true) || !String_1.StringUtils.equals(nextProps.workItemType, this.props.workItemType, true)) {
                if (this._workItemStateItemStore.isLoaded(nextProps.workItemType)) {
                    var workItemTypeStates = this._workItemStateItemStore.getItem(nextProps.workItemType);
                    this.setState({
                        workItemTypeState: Array_1.ArrayUtils.first(workItemTypeStates, function (s) { return String_1.StringUtils.equals(s.name, nextProps.state, true); })
                    });
                }
                else {
                    WorkItemStateItemActions_1.WorkItemStateItemActions.initializeWorkItemStates(nextProps.workItemType);
                }
            }
        };
