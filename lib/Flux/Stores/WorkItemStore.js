define(["require", "exports", "tslib", "../Actions/ActionsHub", "./BaseStore"], function (require, exports, tslib_1, ActionsHub_1, BaseStore_1) {
    ...
    var WorkItemStore = (function (_super) {
        tslib_1.__extends(WorkItemStore, _super);
        ...
        WorkItemStore.prototype.initializeActionListeners = function () {
            var _this = this;
            ActionsHub_1.WorkItemActionsHub.AddOrUpdateWorkItems.subscribe(function (workItems) {
                if (workItems) {
            ...
            ActionsHub_1.WorkItemActionsHub.DeleteWorkItems.subscribe(function (workItemIds) {
                if (workItemIds) {
            ...
            ActionsHub_1.WorkItemActionsHub.ClearWorkItems.subscribe(function () {
                _this.clearStore();
                _this.notify(null, null);
            });
        };
